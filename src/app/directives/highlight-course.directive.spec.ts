...
describe('HighlightCourseDirective', () => {
  ...
  it('should have green border if creationDate >= current day - 14 days', () => {
    const item = fixture.debugElement.queryAll(By.css('.item'))[0];
    expect(item.styles.border).toBe('1px solid rgb(126, 246, 147)');
  });

  it('should have blue border if creationDate > current day', () => {
    fixture = TestBed.createComponent(CourseComponent);
    component = fixture.componentInstance;
    component.item = {
      ...ITEM_MOCK,
      creationDate: moment().add(1, 'd').toString(),
    };
    fixture.detectChanges();
  ...
  it('should have no border if creationDate < current day - 14 days', () => {
    fixture = TestBed.createComponent(CourseComponent);
    component = fixture.componentInstance;
    component.item = {
      ...ITEM_MOCK,
      creationDate: moment().subtract(15, 'd').toString(),
    };
    fixture.detectChanges();
